...
class UScriptStruct* FSlotStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SlotStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSlotStruct, (UObject*)Z_Construct_UPackage__Script_InventorySystem(), TEXT("SlotStruct"));
	}
	return Z_Registration_Info_UScriptStruct_SlotStruct.OuterSingleton;
}
template<> INVENTORYSYSTEM_API UScriptStruct* StaticStruct<FSlotStruct>()
{
...
struct Z_Construct_UScriptStruct_FSlotStruct_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/SlotStruct.h" },
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_ProgramEngineICA2_Plugins_InventorySystem_Source_InventorySystem_Public_SlotStruct_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSlotStruct::StaticStruct, Z_Construct_UScriptStruct_FSlotStruct_Statics::NewStructOps, TEXT("SlotStruct"), &Z_Registration_Info_UScriptStruct_SlotStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSlotStruct), 1522567007U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProgramEngineICA2_Plugins_InventorySystem_Source_InventorySystem_Public_SlotStruct_h_1700219514(TEXT("/Script/InventorySystem"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_ProgramEngineICA2_Plugins_InventorySystem_Source_InventorySystem_Public_SlotStruct_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ProgramEngineICA2_Plugins_InventorySystem_Source_InventorySystem_Public_SlotStruct_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
