...
INVENTORYSYSTEM_API UClass* Z_Construct_UClass_UItem_NoRegister();
INVENTORYSYSTEM_API UEnum* Z_Construct_UEnum_InventorySystem_EInventorySortEnum();
...
INVENTORYSYSTEM_API UFunction* Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature();
INVENTORYSYSTEM_API UScriptStruct* Z_Construct_UScriptStruct_FSlotStruct();
...
struct Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics
{
	struct _Script_InventorySystem_eventOnSlotChanged_Parms
	{
		int32 SlotNumber;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::NewProp_SlotNumber = { "SlotNumber", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_InventorySystem_eventOnSlotChanged_Parms, SlotNumber), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::NewProp_SlotNumber,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_InventorySystem, nullptr, "OnSlotChanged__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::_Script_InventorySystem_eventOnSlotChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::_Script_InventorySystem_eventOnSlotChanged_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnSlotChanged_DelegateWrapper(const FMulticastScriptDelegate& OnSlotChanged, int32 SlotNumber)
{
	...
	_Script_InventorySystem_eventOnSlotChanged_Parms Parms;
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_InventorySystem_OnItemAdded__DelegateSignature_Statics::NewProp_Amount = { "Amount", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_InventorySystem_eventOnItemAdded_Parms, Amount), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_InventorySystem_OnItemAdded__DelegateSignature_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_InventorySystem_OnItemAdded__DelegateSignature_Statics::NewProp_Amount,
};
...
void FOnItemAdded_DelegateWrapper(const FMulticastScriptDelegate& OnItemAdded, UItem* Item, int32 Amount)
{
	struct _Script_InventorySystem_eventOnItemAdded_Parms
	{
		UItem* Item;
...
// Begin Class UInventoryComponent Function MoveFromInventoryToInventory
struct Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics
{
	struct InventoryComponent_eventMoveFromInventoryToInventory_Parms
	{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::NewProp_TargetInventory = { "TargetInventory", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InventoryComponent_eventMoveFromInventoryToInventory_Parms, TargetInventory), Z_Construct_UClass_UInventoryComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TargetInventory_MetaData), NewProp_TargetInventory_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::NewProp_FromSlotIndex = { "FromSlotIndex", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InventoryComponent_eventMoveFromInventoryToInventory_Parms, FromSlotIndex), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::NewProp_ToSlotIndex = { "ToSlotIndex", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InventoryComponent_eventMoveFromInventoryToInventory_Parms, ToSlotIndex), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::NewProp_AmountToMove = { "AmountToMove", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InventoryComponent_eventMoveFromInventoryToInventory_Parms, AmountToMove), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::NewProp_TargetInventory,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::NewProp_FromSlotIndex,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::NewProp_ToSlotIndex,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::NewProp_AmountToMove,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UInventoryComponent, nullptr, "MoveFromInventoryToInventory", nullptr, nullptr, Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::PropPointers), sizeof(Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::InventoryComponent_eventMoveFromInventoryToInventory_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::Function_MetaDataParams), Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::InventoryComponent_eventMoveFromInventoryToInventory_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UInventoryComponent::execMoveFromInventoryToInventory)
{
	P_GET_OBJECT(UInventoryComponent,Z_Param_TargetInventory);
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->MoveFromInventoryToInventory(Z_Param_TargetInventory,Z_Param_FromSlotIndex,Z_Param_ToSlotIndex,Z_Param_AmountToMove);
	P_NATIVE_END;
}
// End Class UInventoryComponent Function MoveFromInventoryToInventory
...
// Begin Class UInventoryComponent Function SortByQuantity
struct Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics
{
	struct InventoryComponent_eventSortByQuantity_Parms
	{
		int32 ArraySize;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::NewProp_ArraySize = { "ArraySize", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InventoryComponent_eventSortByQuantity_Parms, ArraySize), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::NewProp_ArraySize,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UInventoryComponent, nullptr, "SortByQuantity", nullptr, nullptr, Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::PropPointers), sizeof(Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::InventoryComponent_eventSortByQuantity_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::Function_MetaDataParams), Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::InventoryComponent_eventSortByQuantity_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UInventoryComponent_SortByQuantity()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UInventoryComponent_SortByQuantity_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UInventoryComponent::execSortByQuantity)
{
	P_GET_PROPERTY(FIntProperty,Z_Param_ArraySize);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SortByQuantity(Z_Param_ArraySize);
	P_NATIVE_END;
}
// End Class UInventoryComponent Function SortByQuantity
...
// Begin Class UInventoryComponent Function SortByValue
struct Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics
{
	struct InventoryComponent_eventSortByValue_Parms
	{
		int32 ArraySize;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::NewProp_ArraySize = { "ArraySize", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InventoryComponent_eventSortByValue_Parms, ArraySize), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::NewProp_ArraySize,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UInventoryComponent, nullptr, "SortByValue", nullptr, nullptr, Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::PropPointers), sizeof(Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::InventoryComponent_eventSortByValue_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::Function_MetaDataParams), Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::InventoryComponent_eventSortByValue_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UInventoryComponent_SortByValue()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UInventoryComponent_SortByValue_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UInventoryComponent::execSortByValue)
{
	P_GET_PROPERTY(FIntProperty,Z_Param_ArraySize);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SortByValue(Z_Param_ArraySize);
	P_NATIVE_END;
}
// End Class UInventoryComponent Function SortByValue
...
void UInventoryComponent::StaticRegisterNativesUInventoryComponent()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "MoveFromInventoryToInventory", &UInventoryComponent::execMoveFromInventoryToInventory },
		...
		{ "SortByQuantity", &UInventoryComponent::execSortByQuantity },
		{ "SortByRarity", &UInventoryComponent::execSortByRarity },
		{ "SortByValue", &UInventoryComponent::execSortByValue },
...
struct Z_Construct_UClass_UInventoryComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UInventoryComponent_AddItem, "AddItem" }, // 3384410291
		{ &Z_Construct_UFunction_UInventoryComponent_AddItemStackable, "AddItemStackable" }, // 3706350105
		{ &Z_Construct_UFunction_UInventoryComponent_AddNewItem, "AddNewItem" }, // 3779631782
		{ &Z_Construct_UFunction_UInventoryComponent_ClearSlotFromIndex, "ClearSlotFromIndex" }, // 4142329513
		{ &Z_Construct_UFunction_UInventoryComponent_FoundInMap, "FoundInMap" }, // 1546736359
		{ &Z_Construct_UFunction_UInventoryComponent_GetAllItems, "GetAllItems" }, // 2790458026
		{ &Z_Construct_UFunction_UInventoryComponent_GetFirstEmptySlotIndex, "GetFirstEmptySlotIndex" }, // 1191097643
		{ &Z_Construct_UFunction_UInventoryComponent_GetItemAmount, "GetItemAmount" }, // 334761232
		{ &Z_Construct_UFunction_UInventoryComponent_GetItemAmountFromName, "GetItemAmountFromName" }, // 81838806
		{ &Z_Construct_UFunction_UInventoryComponent_GetSlot, "GetSlot" }, // 1301221671
		{ &Z_Construct_UFunction_UInventoryComponent_IsSlotEmpty, "IsSlotEmpty" }, // 251357600
		{ &Z_Construct_UFunction_UInventoryComponent_MoveFromInventoryToInventory, "MoveFromInventoryToInventory" }, // 780923074
		{ &Z_Construct_UFunction_UInventoryComponent_NumberOfSlotsFilledByItemName, "NumberOfSlotsFilledByItemName" }, // 696223129
		{ &Z_Construct_UFunction_UInventoryComponent_RemoveAllItems, "RemoveAllItems" }, // 3630853585
		{ &Z_Construct_UFunction_UInventoryComponent_RemoveItem, "RemoveItem" }, // 3600729040
		{ &Z_Construct_UFunction_UInventoryComponent_RemoveItemByName, "RemoveItemByName" }, // 1743616405
		{ &Z_Construct_UFunction_UInventoryComponent_SortByName, "SortByName" }, // 3044871632
		{ &Z_Construct_UFunction_UInventoryComponent_SortByQuantity, "SortByQuantity" }, // 779958864
		{ &Z_Construct_UFunction_UInventoryComponent_SortByRarity, "SortByRarity" }, // 3842671120
		{ &Z_Construct_UFunction_UInventoryComponent_SortByValue, "SortByValue" }, // 3634519809
		{ &Z_Construct_UFunction_UInventoryComponent_SortByWeight, "SortByWeight" }, // 1148821543
		{ &Z_Construct_UFunction_UInventoryComponent_SortInventory, "SortInventory" }, // 3062888927
		{ &Z_Construct_UFunction_UInventoryComponent_SquashInventory, "SquashInventory" }, // 1532096214
		{ &Z_Construct_UFunction_UInventoryComponent_SwapSlots, "SwapSlots" }, // 2966375014
		{ &Z_Construct_UFunction_UInventoryComponent_TryCombineAllSlots, "TryCombineAllSlots" }, // 435618836
		{ &Z_Construct_UFunction_UInventoryComponent_TryCombineSlots, "TryCombineSlots" }, // 321352628
		{ &Z_Construct_UFunction_UInventoryComponent_TryMoveAmountFromSlotToSlot, "TryMoveAmountFromSlotToSlot" }, // 2146567827
		{ &Z_Construct_UFunction_UInventoryComponent_TryMoveFromSlotToSlot, "TryMoveFromSlotToSlot" }, // 3360013918
	};
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UInventoryComponent_Statics::NewProp_OnInventoryUpdated = { "OnInventoryUpdated", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInventoryComponent, OnInventoryUpdated), Z_Construct_UDelegateFunction_InventorySystem_OnInventoryUpdated__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnInventoryUpdated_MetaData), NewProp_OnInventoryUpdated_MetaData) }; // 175534370
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UInventoryComponent_Statics::NewProp_OnSlotChanged = { "OnSlotChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInventoryComponent, OnSlotChanged), Z_Construct_UDelegateFunction_InventorySystem_OnSlotChanged__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnSlotChanged_MetaData), NewProp_OnSlotChanged_MetaData) }; // 3352963528
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UInventoryComponent_Statics::NewProp_OnItemAdded = { "OnItemAdded", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInventoryComponent, OnItemAdded), Z_Construct_UDelegateFunction_InventorySystem_OnItemAdded__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnItemAdded_MetaData), NewProp_OnItemAdded_MetaData) }; // 1810099528
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UInventoryComponent_Statics::NewProp_SlotArray_Inner = { "SlotArray", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSlotStruct, METADATA_PARAMS(0, nullptr) }; // 1522567007
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInventoryComponent_Statics::NewProp_SlotArray = { "SlotArray", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInventoryComponent, SlotArray), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SlotArray_MetaData), NewProp_SlotArray_MetaData) }; // 1522567007
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_ProgramEngineICA2_Plugins_InventorySystem_Source_InventorySystem_Public_InventoryComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UInventoryComponent, UInventoryComponent::StaticClass, TEXT("UInventoryComponent"), &Z_Registration_Info_UClass_UInventoryComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInventoryComponent), 1655641109U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProgramEngineICA2_Plugins_InventorySystem_Source_InventorySystem_Public_InventoryComponent_h_2765110331(TEXT("/Script/InventorySystem"),
	Z_CompiledInDeferFile_FID_ProgramEngineICA2_Plugins_InventorySystem_Source_InventorySystem_Public_InventoryComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ProgramEngineICA2_Plugins_InventorySystem_Source_InventorySystem_Public_InventoryComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
